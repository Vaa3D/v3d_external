...
public:
	...
	{		
		...
		dialog.AddDialogElement("TranslationX", -20.0, -100.0, 100.0 );
		dialog.AddDialogElement("TranslationY", 0.0, -100.0, 100.0 );
	...
	{  
		...
		progressDialog.show();
		this->RegisterInternalFilter( this->m_ReFilter, 1.0 );
		...
		if(transform_str == "VersorRigid3DTransform")
		{
			...
			typedef itk::BSplineDeformableTransform< CoordinateRepType, 3,3 >               TransformType;
			this->m_ReFilter->SetTransform( (TransformType*) p1 );
                }
