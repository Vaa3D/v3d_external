...
public:
	void Execute(const QString &menu_name, V3DPluginCallback &callback, QWidget *parent)
	{
		...
		if (menu_name == QObject::tr("ITK MinMaxCurvatureFlow Filter ..."))
		{
...
void ITKMinMaxCurvatureFlowPlugin::domenu(const QString & menu_name, V3DPluginCallback & callback, QWidget * parent)
{
