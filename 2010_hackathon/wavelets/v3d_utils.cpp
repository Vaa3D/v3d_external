...
void v3d_utils::rescaleForDisplay(double* input, double* output, int numVoxels, ImagePixelType dataType)
{
	int maxValType;
	switch (dataType)
	{
...
unsigned char* v3d_utils::doubleArrayToCharArray(double* data1dD, int numVoxels, ImagePixelType dataType)
{
...
LandmarkList v3d_utils::getConnectedComponents(double* data1dD, int szx, int szy, int szz, double threshold)
{
	int N = szx * szy * szz;
