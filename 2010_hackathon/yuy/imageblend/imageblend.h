...
public:
    ImageBlendingDialog(V3DPluginCallback &callback, QWidget *parentWidget, QString filename)
	{
		...
		gridLayout->addWidget(label_image1, 2,0); gridLayout->addWidget(edit_img1, 2,1,1,5); gridLayout->addWidget(pb_browse_img1, 2,6);
        ...
        connect(pb_browse_img1, SIGNAL(clicked()), this, SLOT(get_img_name2()));
...
public slots:
	...
	void get_img_name1()
	{
		fn_img1 = QFileDialog::getExistingDirectory(0, QObject::tr("Choose the image 1 "),
                                                   QDir::currentPath(),
    ...
    void get_img_name2()
	{
		fn_img2 = QFileDialog::getExistingDirectory(0, QObject::tr("Choose the image 2 "),
                                                   QDir::currentPath(),
                                                   QFileDialog::ShowDirsOnly);
