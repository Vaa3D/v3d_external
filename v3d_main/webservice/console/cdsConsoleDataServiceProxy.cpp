...
{	struct soap *soap = this;
	...
	if (!&_param_1)
		return soap_closesock(soap);
	soap_default_fw__selectEntityResponse(soap, &_param_1);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__selectEntityResponse(soap, &_param_1, "fw:selectEntityResponse", "");
	if (soap->error)
...
int ConsoleDataServiceProxy::removeAnnotation(const char *endpoint, const char *soap_action, LONG64 annotationId, struct fw__removeAnnotationResponse &_param_3)
{	struct soap *soap = this;
	...
	if (!&_param_3)
		return soap_closesock(soap);
	soap_default_fw__removeAnnotationResponse(soap, &_param_3);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__removeAnnotationResponse(soap, &_param_3, "fw:removeAnnotationResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::getOntology(const char *endpoint, const char *soap_action, LONG64 rootId, struct fw__getOntologyResponse &_param_4)
{	struct soap *soap = this;
	...
	if (!&_param_4)
		return soap_closesock(soap);
	soap_default_fw__getOntologyResponse(soap, &_param_4);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__getOntologyResponse(soap, &_param_4, "fw:getOntologyResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::getAnnotationSession(const char *endpoint, const char *soap_action, LONG64 sessionId, struct fw__getAnnotationSessionResponse &_param_5)
{	struct soap *soap = this;
	...
	if (!&_param_5)
		return soap_closesock(soap);
	soap_default_fw__getAnnotationSessionResponse(soap, &_param_5);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__getAnnotationSessionResponse(soap, &_param_5, "fw:getAnnotationSessionResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::getUserAnnotationColor(const char *endpoint, const char *soap_action, std::string username, struct fw__getUserAnnotationColorResponse &_param_9)
{	struct soap *soap = this;
	...
	if (!&_param_9)
		return soap_closesock(soap);
	soap_default_fw__getUserAnnotationColorResponse(soap, &_param_9);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__getUserAnnotationColorResponse(soap, &_param_9, "fw:getUserAnnotationColorResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::reservePort(const char *endpoint, const char *soap_action, std::string clientName, struct fw__reservePortResponse &_param_10)
{	struct soap *soap = this;
	...
	if (!&_param_10)
		return soap_closesock(soap);
	soap_default_fw__reservePortResponse(soap, &_param_10);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__reservePortResponse(soap, &_param_10, "fw:reservePortResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::registerClient(const char *endpoint, const char *soap_action, int _port, std::string _endpointUrl, struct fw__registerClientResponse &_param_11)
{	struct soap *soap = this;
	...
	if (!&_param_11)
		return soap_closesock(soap);
	soap_default_fw__registerClientResponse(soap, &_param_11);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__registerClientResponse(soap, &_param_11, "fw:registerClientResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::createAnnotation(const char *endpoint, const char *soap_action, fw__ontologyAnnotation *annotation, struct fw__createAnnotationResponse &_param_12)
{	struct soap *soap = this;
	...
	if (!&_param_12)
		return soap_closesock(soap);
	soap_default_fw__createAnnotationResponse(soap, &_param_12);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__createAnnotationResponse(soap, &_param_12, "fw:createAnnotationResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::getKeybindings(const char *endpoint, const char *soap_action, LONG64 ontologyId, struct fw__getKeybindingsResponse &_param_13)
{	struct soap *soap = this;
	...
	if (!&_param_13)
		return soap_closesock(soap);
	soap_default_fw__getKeybindingsResponse(soap, &_param_13);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__getKeybindingsResponse(soap, &_param_13, "fw:getKeybindingsResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int ConsoleDataServiceProxy::getParentEntityDataArray(const char *endpoint, const char *soap_action, LONG64 childEntityId, struct fw__getParentEntityDataArrayResponse &_param_14)
{	struct soap *soap = this;
	...
	if (!&_param_14)
		return soap_closesock(soap);
	soap_default_fw__getParentEntityDataArrayResponse(soap, &_param_14);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_fw__getParentEntityDataArrayResponse(soap, &_param_14, "fw:getParentEntityDataArrayResponse", "");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
