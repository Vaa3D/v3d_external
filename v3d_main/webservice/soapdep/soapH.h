...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__V3DMSG_PLUGINM(struct soap*, const char*, int, const ns__V3DMSG_PLUGINM *, const char*);
SOAP_FMAC3 ns__V3DMSG_PLUGINM * SOAP_FMAC4 soap_in_ns__V3DMSG_PLUGINM(struct soap*, const char*, ns__V3DMSG_PLUGINM *, const char*);

#ifndef soap_write_ns__V3DMSG_PLUGINM
#define soap_write_ns__V3DMSG_PLUGINM(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns:V3DMSG-PLUGINM", NULL) || soap_end_send(soap) )
#endif


#ifndef soap_read_ns__V3DMSG_PLUGINM
#define soap_read_ns__V3DMSG_PLUGINM(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__V3DMSG_PLUGINM(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_PLUGINM * SOAP_FMAC4 soap_get_ns__V3DMSG_PLUGINM(struct soap*, ns__V3DMSG_PLUGINM *, const char*, const char*);

#define soap_new_ns__V3DMSG_PLUGINM(soap, n) soap_instantiate_ns__V3DMSG_PLUGINM(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__V3DMSG_PLUGINM(soap, p) soap_delete(soap, p)

SOAP_FMAC1 ns__V3DMSG_PLUGINM * SOAP_FMAC2 soap_instantiate_ns__V3DMSG_PLUGINM(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__V3DMSG_PLUGINM(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__V3DMSG_SHIFT
#define SOAP_TYPE_ns__V3DMSG_SHIFT (16)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__V3DMSG_SHIFT(struct soap*, const char*, int, const ns__V3DMSG_SHIFT *, const char*);
SOAP_FMAC3 ns__V3DMSG_SHIFT * SOAP_FMAC4 soap_in_ns__V3DMSG_SHIFT(struct soap*, const char*, ns__V3DMSG_SHIFT *, const char*);

#ifndef soap_write_ns__V3DMSG_SHIFT
#define soap_write_ns__V3DMSG_SHIFT(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns:V3DMSG-SHIFT", NULL) || soap_end_send(soap) )
#endif


#ifndef soap_read_ns__V3DMSG_SHIFT
#define soap_read_ns__V3DMSG_SHIFT(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__V3DMSG_SHIFT(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_SHIFT * SOAP_FMAC4 soap_get_ns__V3DMSG_SHIFT(struct soap*, ns__V3DMSG_SHIFT *, const char*, const char*);

#define soap_new_ns__V3DMSG_SHIFT(soap, n) soap_instantiate_ns__V3DMSG_SHIFT(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__V3DMSG_SHIFT(soap, p) soap_delete(soap, p)

SOAP_FMAC1 ns__V3DMSG_SHIFT * SOAP_FMAC2 soap_instantiate_ns__V3DMSG_SHIFT(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__V3DMSG_SHIFT(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__V3DMSG_ZOOM
#define SOAP_TYPE_ns__V3DMSG_ZOOM (15)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__V3DMSG_ZOOM(struct soap*, const char*, int, const ns__V3DMSG_ZOOM *, const char*);
SOAP_FMAC3 ns__V3DMSG_ZOOM * SOAP_FMAC4 soap_in_ns__V3DMSG_ZOOM(struct soap*, const char*, ns__V3DMSG_ZOOM *, const char*);

#ifndef soap_write_ns__V3DMSG_ZOOM
#define soap_write_ns__V3DMSG_ZOOM(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns:V3DMSG-ZOOM", NULL) || soap_end_send(soap) )
#endif


#ifndef soap_read_ns__V3DMSG_ZOOM
#define soap_read_ns__V3DMSG_ZOOM(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__V3DMSG_ZOOM(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_ZOOM * SOAP_FMAC4 soap_get_ns__V3DMSG_ZOOM(struct soap*, ns__V3DMSG_ZOOM *, const char*, const char*);

#define soap_new_ns__V3DMSG_ZOOM(soap, n) soap_instantiate_ns__V3DMSG_ZOOM(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__V3DMSG_ZOOM(soap, p) soap_delete(soap, p)

SOAP_FMAC1 ns__V3DMSG_ZOOM * SOAP_FMAC2 soap_instantiate_ns__V3DMSG_ZOOM(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__V3DMSG_ZOOM(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__V3DMSG_ROTATION
#define SOAP_TYPE_ns__V3DMSG_ROTATION (14)
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__V3DMSG_ROTATION(struct soap*, const char*, int, const ns__V3DMSG_ROTATION *, const char*);
SOAP_FMAC3 ns__V3DMSG_ROTATION * SOAP_FMAC4 soap_in_ns__V3DMSG_ROTATION(struct soap*, const char*, ns__V3DMSG_ROTATION *, const char*);

#ifndef soap_write_ns__V3DMSG_ROTATION
#define soap_write_ns__V3DMSG_ROTATION(soap, data) ( soap_begin_send(soap) || ((data)->soap_serialize(soap), 0) || (data)->soap_put(soap, "ns:V3DMSG-ROTATION", NULL) || soap_end_send(soap) )
#endif


#ifndef soap_read_ns__V3DMSG_ROTATION
#define soap_read_ns__V3DMSG_ROTATION(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__V3DMSG_ROTATION(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_ROTATION * SOAP_FMAC4 soap_get_ns__V3DMSG_ROTATION(struct soap*, ns__V3DMSG_ROTATION *, const char*, const char*);

#define soap_new_ns__V3DMSG_ROTATION(soap, n) soap_instantiate_ns__V3DMSG_ROTATION(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__V3DMSG_ROTATION(soap, p) soap_delete(soap, p)

SOAP_FMAC1 ns__V3DMSG_ROTATION * SOAP_FMAC2 soap_instantiate_ns__V3DMSG_ROTATION(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__V3DMSG_ROTATION(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__v3dwscallpluginmethod(struct soap*, struct ns__v3dwscallpluginmethod *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__v3dwscallpluginmethod(struct soap*, const struct ns__v3dwscallpluginmethod *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__v3dwscallpluginmethod(struct soap*, const char*, int, const struct ns__v3dwscallpluginmethod *, const char*);
SOAP_FMAC3 struct ns__v3dwscallpluginmethod * SOAP_FMAC4 soap_in_ns__v3dwscallpluginmethod(struct soap*, const char*, struct ns__v3dwscallpluginmethod *, const char*);

#ifndef soap_write_ns__v3dwscallpluginmethod
#define soap_write_ns__v3dwscallpluginmethod(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__v3dwscallpluginmethod(soap, data), 0) || soap_put_ns__v3dwscallpluginmethod(soap, data, "ns:v3dwscallpluginmethod", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__v3dwscallpluginmethod(struct soap*, const struct ns__v3dwscallpluginmethod *, const char*, const char*);

#ifndef soap_read_ns__v3dwscallpluginmethod
#define soap_read_ns__v3dwscallpluginmethod(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__v3dwscallpluginmethod(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__v3dwscallpluginmethod * SOAP_FMAC4 soap_get_ns__v3dwscallpluginmethod(struct soap*, struct ns__v3dwscallpluginmethod *, const char*, const char*);

#define soap_new_ns__v3dwscallpluginmethod(soap, n) soap_instantiate_ns__v3dwscallpluginmethod(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__v3dwscallpluginmethod(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__v3dwscallpluginmethod * SOAP_FMAC2 soap_instantiate_ns__v3dwscallpluginmethod(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__v3dwscallpluginmethod(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__v3dopenfile3dwshift
#define SOAP_TYPE_ns__v3dopenfile3dwshift (40)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__v3dopenfile3dwshift(struct soap*, struct ns__v3dopenfile3dwshift *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__v3dopenfile3dwshift(struct soap*, const struct ns__v3dopenfile3dwshift *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__v3dopenfile3dwshift(struct soap*, const char*, int, const struct ns__v3dopenfile3dwshift *, const char*);
SOAP_FMAC3 struct ns__v3dopenfile3dwshift * SOAP_FMAC4 soap_in_ns__v3dopenfile3dwshift(struct soap*, const char*, struct ns__v3dopenfile3dwshift *, const char*);

#ifndef soap_write_ns__v3dopenfile3dwshift
#define soap_write_ns__v3dopenfile3dwshift(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__v3dopenfile3dwshift(soap, data), 0) || soap_put_ns__v3dopenfile3dwshift(soap, data, "ns:v3dopenfile3dwshift", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__v3dopenfile3dwshift(struct soap*, const struct ns__v3dopenfile3dwshift *, const char*, const char*);

#ifndef soap_read_ns__v3dopenfile3dwshift
#define soap_read_ns__v3dopenfile3dwshift(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__v3dopenfile3dwshift(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__v3dopenfile3dwshift * SOAP_FMAC4 soap_get_ns__v3dopenfile3dwshift(struct soap*, struct ns__v3dopenfile3dwshift *, const char*, const char*);

#define soap_new_ns__v3dopenfile3dwshift(soap, n) soap_instantiate_ns__v3dopenfile3dwshift(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__v3dopenfile3dwshift(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__v3dopenfile3dwshift * SOAP_FMAC2 soap_instantiate_ns__v3dopenfile3dwshift(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__v3dopenfile3dwshift(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__v3dopenfile3dwzoom
#define SOAP_TYPE_ns__v3dopenfile3dwzoom (37)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__v3dopenfile3dwzoom(struct soap*, struct ns__v3dopenfile3dwzoom *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__v3dopenfile3dwzoom(struct soap*, const struct ns__v3dopenfile3dwzoom *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__v3dopenfile3dwzoom(struct soap*, const char*, int, const struct ns__v3dopenfile3dwzoom *, const char*);
SOAP_FMAC3 struct ns__v3dopenfile3dwzoom * SOAP_FMAC4 soap_in_ns__v3dopenfile3dwzoom(struct soap*, const char*, struct ns__v3dopenfile3dwzoom *, const char*);

#ifndef soap_write_ns__v3dopenfile3dwzoom
#define soap_write_ns__v3dopenfile3dwzoom(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__v3dopenfile3dwzoom(soap, data), 0) || soap_put_ns__v3dopenfile3dwzoom(soap, data, "ns:v3dopenfile3dwzoom", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__v3dopenfile3dwzoom(struct soap*, const struct ns__v3dopenfile3dwzoom *, const char*, const char*);

#ifndef soap_read_ns__v3dopenfile3dwzoom
#define soap_read_ns__v3dopenfile3dwzoom(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__v3dopenfile3dwzoom(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__v3dopenfile3dwzoom * SOAP_FMAC4 soap_get_ns__v3dopenfile3dwzoom(struct soap*, struct ns__v3dopenfile3dwzoom *, const char*, const char*);

#define soap_new_ns__v3dopenfile3dwzoom(soap, n) soap_instantiate_ns__v3dopenfile3dwzoom(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__v3dopenfile3dwzoom(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__v3dopenfile3dwzoom * SOAP_FMAC2 soap_instantiate_ns__v3dopenfile3dwzoom(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__v3dopenfile3dwzoom(struct soap*, int, int, void*, size_t, const void*, size_t);

#ifndef SOAP_TYPE_ns__v3dopenfile3dwrot
#define SOAP_TYPE_ns__v3dopenfile3dwrot (34)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__v3dopenfile3dwrot(struct soap*, struct ns__v3dopenfile3dwrot *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__v3dopenfile3dwrot(struct soap*, const struct ns__v3dopenfile3dwrot *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__v3dopenfile3dwrot(struct soap*, const char*, int, const struct ns__v3dopenfile3dwrot *, const char*);
SOAP_FMAC3 struct ns__v3dopenfile3dwrot * SOAP_FMAC4 soap_in_ns__v3dopenfile3dwrot(struct soap*, const char*, struct ns__v3dopenfile3dwrot *, const char*);

#ifndef soap_write_ns__v3dopenfile3dwrot
#define soap_write_ns__v3dopenfile3dwrot(soap, data) ( soap_begin_send(soap) || (soap_serialize_ns__v3dopenfile3dwrot(soap, data), 0) || soap_put_ns__v3dopenfile3dwrot(soap, data, "ns:v3dopenfile3dwrot", NULL) || soap_end_send(soap) )
#endif


SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__v3dopenfile3dwrot(struct soap*, const struct ns__v3dopenfile3dwrot *, const char*, const char*);

#ifndef soap_read_ns__v3dopenfile3dwrot
#define soap_read_ns__v3dopenfile3dwrot(soap, data) ( soap_begin_recv(soap) || !soap_get_ns__v3dopenfile3dwrot(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 struct ns__v3dopenfile3dwrot * SOAP_FMAC4 soap_get_ns__v3dopenfile3dwrot(struct soap*, struct ns__v3dopenfile3dwrot *, const char*, const char*);

#define soap_new_ns__v3dopenfile3dwrot(soap, n) soap_instantiate_ns__v3dopenfile3dwrot(soap, n, NULL, NULL, NULL)


#define soap_delete_ns__v3dopenfile3dwrot(soap, p) soap_delete(soap, p)

SOAP_FMAC1 struct ns__v3dopenfile3dwrot * SOAP_FMAC2 soap_instantiate_ns__v3dopenfile3dwrot(struct soap*, int, const char*, const char*, size_t*);
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_ns__v3dopenfile3dwrot(struct soap*, int, int, void*, size_t, const void*, size_t);
...
#ifndef SOAP_TYPE_PointerTons__V3DMSG_PLUGINM
#define SOAP_TYPE_PointerTons__V3DMSG_PLUGINM (41)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons__V3DMSG_PLUGINM(struct soap*, ns__V3DMSG_PLUGINM *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons__V3DMSG_PLUGINM(struct soap*, const char *, int, ns__V3DMSG_PLUGINM *const*, const char *);
SOAP_FMAC3 ns__V3DMSG_PLUGINM ** SOAP_FMAC4 soap_in_PointerTons__V3DMSG_PLUGINM(struct soap*, const char*, ns__V3DMSG_PLUGINM **, const char*);

#ifndef soap_write_PointerTons__V3DMSG_PLUGINM
#define soap_write_PointerTons__V3DMSG_PLUGINM(soap, data) ( soap_begin_send(soap) || (soap_serialize_PointerTons__V3DMSG_PLUGINM(soap, data), 0) || soap_put_PointerTons__V3DMSG_PLUGINM(soap, data, "ns:V3DMSG-PLUGINM", NULL) || soap_end_send(soap) )
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons__V3DMSG_PLUGINM(struct soap*, ns__V3DMSG_PLUGINM *const*, const char*, const char*);

#ifndef soap_read_PointerTons__V3DMSG_PLUGINM
#define soap_read_PointerTons__V3DMSG_PLUGINM(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTons__V3DMSG_PLUGINM(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_PLUGINM ** SOAP_FMAC4 soap_get_PointerTons__V3DMSG_PLUGINM(struct soap*, ns__V3DMSG_PLUGINM **, const char*, const char*);

#ifndef SOAP_TYPE_PointerTons__V3DMSG_SHIFT
#define SOAP_TYPE_PointerTons__V3DMSG_SHIFT (38)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons__V3DMSG_SHIFT(struct soap*, ns__V3DMSG_SHIFT *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons__V3DMSG_SHIFT(struct soap*, const char *, int, ns__V3DMSG_SHIFT *const*, const char *);
SOAP_FMAC3 ns__V3DMSG_SHIFT ** SOAP_FMAC4 soap_in_PointerTons__V3DMSG_SHIFT(struct soap*, const char*, ns__V3DMSG_SHIFT **, const char*);

#ifndef soap_write_PointerTons__V3DMSG_SHIFT
#define soap_write_PointerTons__V3DMSG_SHIFT(soap, data) ( soap_begin_send(soap) || (soap_serialize_PointerTons__V3DMSG_SHIFT(soap, data), 0) || soap_put_PointerTons__V3DMSG_SHIFT(soap, data, "ns:V3DMSG-SHIFT", NULL) || soap_end_send(soap) )
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons__V3DMSG_SHIFT(struct soap*, ns__V3DMSG_SHIFT *const*, const char*, const char*);

#ifndef soap_read_PointerTons__V3DMSG_SHIFT
#define soap_read_PointerTons__V3DMSG_SHIFT(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTons__V3DMSG_SHIFT(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_SHIFT ** SOAP_FMAC4 soap_get_PointerTons__V3DMSG_SHIFT(struct soap*, ns__V3DMSG_SHIFT **, const char*, const char*);

#ifndef SOAP_TYPE_PointerTons__V3DMSG_ZOOM
#define SOAP_TYPE_PointerTons__V3DMSG_ZOOM (35)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons__V3DMSG_ZOOM(struct soap*, ns__V3DMSG_ZOOM *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons__V3DMSG_ZOOM(struct soap*, const char *, int, ns__V3DMSG_ZOOM *const*, const char *);
SOAP_FMAC3 ns__V3DMSG_ZOOM ** SOAP_FMAC4 soap_in_PointerTons__V3DMSG_ZOOM(struct soap*, const char*, ns__V3DMSG_ZOOM **, const char*);

#ifndef soap_write_PointerTons__V3DMSG_ZOOM
#define soap_write_PointerTons__V3DMSG_ZOOM(soap, data) ( soap_begin_send(soap) || (soap_serialize_PointerTons__V3DMSG_ZOOM(soap, data), 0) || soap_put_PointerTons__V3DMSG_ZOOM(soap, data, "ns:V3DMSG-ZOOM", NULL) || soap_end_send(soap) )
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons__V3DMSG_ZOOM(struct soap*, ns__V3DMSG_ZOOM *const*, const char*, const char*);

#ifndef soap_read_PointerTons__V3DMSG_ZOOM
#define soap_read_PointerTons__V3DMSG_ZOOM(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTons__V3DMSG_ZOOM(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_ZOOM ** SOAP_FMAC4 soap_get_PointerTons__V3DMSG_ZOOM(struct soap*, ns__V3DMSG_ZOOM **, const char*, const char*);

#ifndef SOAP_TYPE_PointerTons__V3DMSG_ROTATION
#define SOAP_TYPE_PointerTons__V3DMSG_ROTATION (32)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons__V3DMSG_ROTATION(struct soap*, ns__V3DMSG_ROTATION *const*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons__V3DMSG_ROTATION(struct soap*, const char *, int, ns__V3DMSG_ROTATION *const*, const char *);
SOAP_FMAC3 ns__V3DMSG_ROTATION ** SOAP_FMAC4 soap_in_PointerTons__V3DMSG_ROTATION(struct soap*, const char*, ns__V3DMSG_ROTATION **, const char*);

#ifndef soap_write_PointerTons__V3DMSG_ROTATION
#define soap_write_PointerTons__V3DMSG_ROTATION(soap, data) ( soap_begin_send(soap) || (soap_serialize_PointerTons__V3DMSG_ROTATION(soap, data), 0) || soap_put_PointerTons__V3DMSG_ROTATION(soap, data, "ns:V3DMSG-ROTATION", NULL) || soap_end_send(soap) )
#endif

SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons__V3DMSG_ROTATION(struct soap*, ns__V3DMSG_ROTATION *const*, const char*, const char*);

#ifndef soap_read_PointerTons__V3DMSG_ROTATION
#define soap_read_PointerTons__V3DMSG_ROTATION(soap, data) ( soap_begin_recv(soap) || !soap_get_PointerTons__V3DMSG_ROTATION(soap, data, NULL, NULL) || soap_end_recv(soap) )
#endif

SOAP_FMAC3 ns__V3DMSG_ROTATION ** SOAP_FMAC4 soap_get_PointerTons__V3DMSG_ROTATION(struct soap*, ns__V3DMSG_ROTATION **, const char*, const char*);

#ifndef SOAP_TYPE_PointerTons__V3DMSG
#define SOAP_TYPE_PointerTons__V3DMSG (29)
#endif
...
#define SOAP_TYPE_PointerTons__LOAD_RES (23)
#endif
...
#define SOAP_TYPE_PointerTons__LOAD_MSG (22)
#endif
