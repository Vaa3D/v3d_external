...
static int serve_ns__v3dopenfile3d(v3dwebserverService*);
...
{	soap_peek_element(this);
	...
	if (!soap_match_tag(this, this->tag, "ns:v3dopenfile3d"))
		return serve_ns__v3dopenfile3d(this);
	if (!soap_match_tag(this, this->tag, "ns:v3dopenfile3dwrot"))
		return serve_ns__v3dopenfile3dwrot(this);
	if (!soap_match_tag(this, this->tag, "ns:v3dopenfile3dwzoom"))
...
static int serve_ns__v3dopenfile3d(v3dwebserverService *soap)
{	struct ns__v3dopenfile3d soap_tmp_ns__v3dopenfile3d;
	ns__V3DMSG output;
	output.soap_default(soap);
	soap_default_ns__v3dopenfile3d(soap, &soap_tmp_ns__v3dopenfile3d);
	soap->encodingStyle = "";
	if (!soap_get_ns__v3dopenfile3d(soap, &soap_tmp_ns__v3dopenfile3d, "ns:v3dopenfile3d", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->v3dopenfile3d(soap_tmp_ns__v3dopenfile3d.input, &output);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || output.soap_put(soap, "ns:V3DMSG", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve_ns__v3dopenfile3dwrot(v3dwebserverService *soap)
{	struct ns__v3dopenfile3dwrot soap_tmp_ns__v3dopenfile3dwrot;
	ns__V3DMSG_ROTATION output;
	output.soap_default(soap);
	soap_default_ns__v3dopenfile3dwrot(soap, &soap_tmp_ns__v3dopenfile3dwrot);
	soap->encodingStyle = "";
	if (!soap_get_ns__v3dopenfile3dwrot(soap, &soap_tmp_ns__v3dopenfile3dwrot, "ns:v3dopenfile3dwrot", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->v3dopenfile3dwrot(soap_tmp_ns__v3dopenfile3dwrot.input, &output);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	output.soap_serialize(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || output.soap_put(soap, "ns:V3DMSG-ROTATION", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve_ns__v3dopenfile3dwzoom(v3dwebserverService *soap)
{	struct ns__v3dopenfile3dwzoom soap_tmp_ns__v3dopenfile3dwzoom;
	ns__V3DMSG_ZOOM output;
	output.soap_default(soap);
	soap_default_ns__v3dopenfile3dwzoom(soap, &soap_tmp_ns__v3dopenfile3dwzoom);
	soap->encodingStyle = "";
	if (!soap_get_ns__v3dopenfile3dwzoom(soap, &soap_tmp_ns__v3dopenfile3dwzoom, "ns:v3dopenfile3dwzoom", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->v3dopenfile3dwzoom(soap_tmp_ns__v3dopenfile3dwzoom.input, &output);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	output.soap_serialize(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || output.soap_put(soap, "ns:V3DMSG-ZOOM", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve_ns__v3dopenfile3dwshift(v3dwebserverService *soap)
{	struct ns__v3dopenfile3dwshift soap_tmp_ns__v3dopenfile3dwshift;
	ns__V3DMSG_SHIFT output;
	output.soap_default(soap);
	soap_default_ns__v3dopenfile3dwshift(soap, &soap_tmp_ns__v3dopenfile3dwshift);
	soap->encodingStyle = "";
	if (!soap_get_ns__v3dopenfile3dwshift(soap, &soap_tmp_ns__v3dopenfile3dwshift, "ns:v3dopenfile3dwshift", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->v3dopenfile3dwshift(soap_tmp_ns__v3dopenfile3dwshift.input, &output);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	output.soap_serialize(soap);
