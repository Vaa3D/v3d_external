...
public:
    ...
    {
        Dialog_v3d_preference->setWindowTitle(QApplication::translate("Dialog_v3d_preference", "Preferences", 0));
        checkBox_yaxis_up->setText(QApplication::translate("Dialog_v3d_preference", "Y axis direction (from bottom to top)", 0));
        checkBox_autoConvert2_8bit->setText(QApplication::translate("Dialog_v3d_preference", "Automatic conversion 16(32)bit to 8bit when open an image", 0));
        label_4->setText(QApplication::translate("Dialog_v3d_preference", "# bits to shift for 16(32)bit->8bit conversion \n"
"(-1) for manual input", 0));
        checkBox_autoRescale16bitDisplay->setText(QApplication::translate("Dialog_v3d_preference", "Automatic rescale 16bit data in display", 0));
        label_2->setText(QApplication::translate("Dialog_v3d_preference", "Looking glass size  (radius, # pixels)", 0));
        label->setText(QApplication::translate("Dialog_v3d_preference", "Default marker size (radius, # pixels)", 0));
        checkBox_libTiff_Mylib->setText(QApplication::translate("Dialog_v3d_preference", "Use Libtiff (ON) (for <2G file) or MYLib (OFF) (for >2G file) for TIFF/LSM file", 0));
        checkBox_blendColor->setText(QApplication::translate("Dialog_v3d_preference", "Blend multi-channel's color", 0));
        V3D_MainWindows->setTabText(V3D_MainWindows->indexOf(V3D_setting_mainwindow), QApplication::translate("Dialog_v3d_preference", "Main TriView Window", 0));
        groupBox_2->setTitle(QApplication::translate("Dialog_v3d_preference", "Automatic video-card mode", 0));
        checkBox_autoVideoCardCompress->setText(QApplication::translate("Dialog_v3d_preference", "compression mode", 0));
        checkBox_autoVideoCard3DTex->setText(QApplication::translate("Dialog_v3d_preference", "3D texture mode (Not preferred for large volume)", 0));
        checkBox_autoVideoCardNPTTex->setText(QApplication::translate("Dialog_v3d_preference", "non-power-of-two size texture mode", 0));
        label_7->setText(QApplication::translate("Dialog_v3d_preference", "Stream texture mode (detail in Alt-V in 3D Viewer)", 0));
        checkBox_scrollupZoomin->setText(QApplication::translate("Dialog_v3d_preference", "Mouse wheel scroll-up/down for zoom-in/out", 0));
        checkBox_autoOpenImg3DViewer->setText(QApplication::translate("Dialog_v3d_preference", "Automatic launch 3D viewer when open an image", 0));
        checkBox_autoDispXYZAxes->setText(QApplication::translate("Dialog_v3d_preference", "Automatic display XYZ axes of the 3D scene", 0));
        checkBox_autoDispBoundingBox->setText(QApplication::translate("Dialog_v3d_preference", "Automatic display bounding box of scene", 0));
        label_3->setText(QApplication::translate("Dialog_v3d_preference", "Default marker display zoom factor ", 0));
        checkBox_autoSWCLineMode->setText(QApplication::translate("Dialog_v3d_preference", "Default display SWC file in LINE mode (skeleton only)", 0));
        V3D_MainWindows->setTabText(V3D_MainWindows->indexOf(V3D_setting_3dviewer), QApplication::translate("Dialog_v3d_preference", "3D Viewer", 0));
        groupBox->setTitle(QApplication::translate("Dialog_v3d_preference", "3D image registration (disabled as of now; will be avaiable as a plugin)", 0));
        label_5->setText(QApplication::translate("Dialog_v3d_preference", "Landmark matching method", 0));
        comboBox_reg_markermatch_method->clear();
        comboBox_reg_markermatch_method->insertItems(0, QStringList()
         << QApplication::translate("Dialog_v3d_preference", "MATCH_MI", 0)
         << QApplication::translate("Dialog_v3d_preference", "MATCH_MULTIPLE_MI_INT_CORR", 0)
         << QApplication::translate("Dialog_v3d_preference", "MATCH_INTENSITY", 0)
         << QApplication::translate("Dialog_v3d_preference", "MATCH_CORRCOEF", 0)
         << QApplication::translate("Dialog_v3d_preference", "MATCH_IMOMENT", 0)
         << QApplication::translate("Dialog_v3d_preference", "MATCH_MEANOFCIRCLES", 0)
        );
...
"generating method", 0));
        ...
        comboBox_warpingfield_method->insertItems(0, QStringList()
         << QApplication::translate("Dialog_v3d_preference", "TPS", 0)
         << QApplication::translate("Dialog_v3d_preference", "Hier-B-Spline", 0)
         << QApplication::translate("Dialog_v3d_preference", "TPS-B-Spline-interpolation", 0)
         << QApplication::translate("Dialog_v3d_preference", "TPS-linear-interpolation", 0)
        );
        groupBox_3->setTitle(QApplication::translate("Dialog_v3d_preference", "3D curve", 0));
        checkBox_3dcurve_inertia->setText(QApplication::translate("Dialog_v3d_preference", "3D curve-node fitting using inertia-rule (close to the last node)", 0));
        checkBox_3dcurve_autoconnecttips->setText(QApplication::translate("Dialog_v3d_preference", "auto-connect start/end tips to existing neuron/curve nodes", 0));
        checkBox_3dcurve_autodeform->setText(QApplication::translate("Dialog_v3d_preference", "auto-deform based on img content", 0));
        checkBox_3dcurve_autowidth->setText(QApplication::translate("Dialog_v3d_preference", "auto-estimate width", 0));
        checkBox_3dcurve_width_from_xyonly->setText(QApplication::translate("Dialog_v3d_preference", "estimate curve width based on XY plane only (but not XYZ)", 0));
        V3D_MainWindows->setTabText(V3D_MainWindows->indexOf(V3D_setting_imganalysis), QApplication::translate("Dialog_v3d_preference", "Image Analysis", 0));
        label_8->setText(QApplication::translate("Dialog_v3d_preference", "Default channel id for plugin image analysis (-1 for all channels)", 0));
        checkBox_b_plugin_dispResInNewWindow->setText(QApplication::translate("Dialog_v3d_preference", "Display plugin results in a new window", 0));
        checkBox_b_plugin_dispParameterDialog->setText(QApplication::translate("Dialog_v3d_preference", "Ask for plugin parameters every time", 0));
        checkBox_b_plugin_outputImgRescale->setText(QApplication::translate("Dialog_v3d_preference", "Rescale plugin output image intensity to [0, 255]", 0));
        checkBox_b_plugin_outputImgConvert2UINT8->setText(QApplication::translate("Dialog_v3d_preference", "Convert plugin output as UINT8 (if turn off, then will be 32bit float)", 0));
        V3D_MainWindows->setTabText(V3D_MainWindows->indexOf(tab), QApplication::translate("Dialog_v3d_preference", "Plugins", 0));
        pushButton_cancel->setText(QApplication::translate("Dialog_v3d_preference", "Cancel", 0));
        pushButton_ok->setText(QApplication::translate("Dialog_v3d_preference", "OK", 0));
    } // retranslateUi
