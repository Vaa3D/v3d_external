...
public:
    ...
    {
        dialog_update_options->setWindowTitle(QApplication::translate("dialog_update_options", "V3D updater options", 0));
        label_3->setText(QApplication::translate("dialog_update_options", "How often do you want Vaa3D to automatically check for updates?", 0));
        label_2->setText(QApplication::translate("dialog_update_options", "Check for &updates", 0));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("dialog_update_options", "every time", 0)
         << QApplication::translate("dialog_update_options", "once a day", 0)
         << QApplication::translate("dialog_update_options", "once a week", 0)
         << QApplication::translate("dialog_update_options", "once a month", 0)
         << QApplication::translate("dialog_update_options", "never", 0)
        );
        label_4->setText(QApplication::translate("dialog_update_options", "Where do you want to get updates from?", 0));
        label->setText(QApplication::translate("dialog_update_options", "Vaa3D version URL", 0));
        useDefaultVersionButton->setText(QApplication::translate("dialog_update_options", "Use official Vaa3D version URL", 0));
    } // retranslateUi
