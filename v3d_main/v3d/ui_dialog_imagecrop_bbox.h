...
public:
    ...
    {
        Dialog_ImageCrop_BBox->setWindowTitle(QApplication::translate("Dialog_ImageCrop_BBox", "Image Crop Options", 0));
        label_5->setText(QApplication::translate("Dialog_ImageCrop_BBox", "Min", 0));
        label_6->setText(QApplication::translate("Dialog_ImageCrop_BBox", "Max", 0));
        label_2->setText(QApplication::translate("Dialog_ImageCrop_BBox", "X :", 0));
        label_3->setText(QApplication::translate("Dialog_ImageCrop_BBox", "Y :", 0));
        label_4->setText(QApplication::translate("Dialog_ImageCrop_BBox", "Z :", 0));
        label_7->setText(QApplication::translate("Dialog_ImageCrop_BBox", "Color channel:", 0));
        label->setText(QApplication::translate("Dialog_ImageCrop_BBox", "Landmarks options : ", 0));
        landmarksBox->clear();
        landmarksBox->insertItems(0, QStringList()
         << QApplication::translate("Dialog_ImageCrop_BBox", "Subtract min and delete landmarks outside the bounding box", 0)
         << QApplication::translate("Dialog_ImageCrop_BBox", "Subtract min and keep landmarks outside the bounding box", 0)
         << QApplication::translate("Dialog_ImageCrop_BBox", "Do not alter landmark coordinates", 0)
        );
        cancelButton->setText(QApplication::translate("Dialog_ImageCrop_BBox", "Cancel", 0));
        okButton->setText(QApplication::translate("Dialog_ImageCrop_BBox", "OK", 0));
        infolabel->setText(QApplication::translate("Dialog_ImageCrop_BBox", "info: Crop Image Options", 0));
    } // retranslateUi
