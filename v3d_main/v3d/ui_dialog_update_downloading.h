...
public:
    ...
    {
        downloading_updates_dialog->setWindowTitle(QApplication::translate("downloading_updates_dialog", "V3D software update", 0));
        iconLabel->setText(QString());
        textLabel->setText(QApplication::translate("downloading_updates_dialog", "V3D is downloading updates", 0));
        informativeTextLabel->setText(QApplication::translate("downloading_updates_dialog", "Examining files...", 0));
    } // retranslateUi
