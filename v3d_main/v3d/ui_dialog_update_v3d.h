...
public:
    ...
    {
        dialog_update_v3d->setWindowTitle(QApplication::translate("dialog_update_v3d", "Check for new V3D software", 0));
        label_2->setText(QApplication::translate("dialog_update_v3d", "Do you want to check for Vaa3D software updates?", 0));
    } // retranslateUi
