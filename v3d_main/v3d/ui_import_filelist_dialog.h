...
public:
    ...
    {
        import_filelist_tool->setWindowTitle(QApplication::translate("import_filelist_tool", "Image/file sequence importer", 0));
        filterButton->setText(QApplication::translate("import_filelist_tool", "File name filter", 0));
        numimgButton->setText(QApplication::translate("import_filelist_tool", "# files-filtered in this folder", 0));
        cancelButton->setText(QApplication::translate("import_filelist_tool", "Cancel", 0));
        okButton->setText(QApplication::translate("import_filelist_tool", "OK", 0));
    } // retranslateUi
