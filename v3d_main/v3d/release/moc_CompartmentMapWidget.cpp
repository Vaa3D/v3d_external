...
void CompartmentMapWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CompartmentMapWidget *_t = static_cast<CompartmentMapWidget *>(_o);
        switch (_id) {
        case 0: _t->viscomp3dview((*reinterpret_cast< const QList<LabelSurf>(*)>(_a[1]))); break;
        case 1: _t->switchCompartment((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->setRotation((*reinterpret_cast< const Rotation3D(*)>(_a[1]))); break;
        case 3: _t->setFocus((*reinterpret_cast< const Vector3D(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData CompartmentMapWidget::staticMetaObjectExtraData = {
...
const QMetaObject CompartmentMapWidget::staticMetaObject = {
    { &V3dR_GLWidget::staticMetaObject, qt_meta_stringdata_CompartmentMapWidget,
      qt_meta_data_CompartmentMapWidget, &staticMetaObjectExtraData }
};
