...
void AnnotatedBranchTreeModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData AnnotatedBranchTreeModel::staticMetaObjectExtraData = {
...
const QMetaObject AnnotatedBranchTreeModel::staticMetaObject = {
    { &EntityTreeModel::staticMetaObject, qt_meta_stringdata_AnnotatedBranchTreeModel,
      qt_meta_data_AnnotatedBranchTreeModel, &staticMetaObjectExtraData }
};
