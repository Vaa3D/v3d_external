...
public:
    ...
    {
        Dialog_vano_linkerloader->setWindowTitle(QApplication::translate("Dialog_vano_linkerloader", "Linker file editor", 0));
        label_rawimg->setText(QApplication::translate("Dialog_vano_linkerloader", "Raw Image", 0));
        pushButton_rawimg->setText(QApplication::translate("Dialog_vano_linkerloader", "File ...", 0));
        label_maskimg->setText(QApplication::translate("Dialog_vano_linkerloader", "Mask Image", 0));
        pushButton_maskimg->setText(QApplication::translate("Dialog_vano_linkerloader", "File ...", 0));
        label_apofile->setText(QApplication::translate("Dialog_vano_linkerloader", "Annotation file", 0));
        pushButton_apofile->setText(QApplication::translate("Dialog_vano_linkerloader", "File ...", 0));
        label->setText(QApplication::translate("Dialog_vano_linkerloader", "Tip: if any texts above become red color, the files do NOT exist!", 0));
        pushButton_cancel->setText(QApplication::translate("Dialog_vano_linkerloader", "Cancel", 0));
        pushButton_loaddata->setText(QApplication::translate("Dialog_vano_linkerloader", "Load data", 0));
    } // retranslateUi
