...
public:
    ...
    {
        Dialog_ImageResample->setWindowTitle(QApplication::translate("Dialog_ImageResample", "Dialog", 0));
        label->setText(QApplication::translate("Dialog_ImageResample", "Axis/axes along which to resample image", 0));
        axesBox->clear();
        axesBox->insertItems(0, QStringList()
         << QApplication::translate("Dialog_ImageResample", "Z axis", 0)
         << QApplication::translate("Dialog_ImageResample", "XY axis (in proportion)", 0)
         << QApplication::translate("Dialog_ImageResample", "XYZ axis (in proportion)", 0)
         << QApplication::translate("Dialog_ImageResample", "X axis", 0)
         << QApplication::translate("Dialog_ImageResample", "Y axis", 0)
        );
        label_3->setText(QApplication::translate("Dialog_ImageResample", "current pixel size (um) :", 0));
        label_4->setText(QApplication::translate("Dialog_ImageResample", "target pixel size (um) :", 0));
        label_2->setText(QApplication::translate("Dialog_ImageResample", "Voxel/pixel interpolation method:", 0));
        interp_method_box->clear();
        interp_method_box->insertItems(0, QStringList()
         << QApplication::translate("Dialog_ImageResample", "nearest neighbor interpolation", 0)
         << QApplication::translate("Dialog_ImageResample", "linear interpolation", 0)
        );
        cancelButton->setText(QApplication::translate("Dialog_ImageResample", "Cancel", 0));
        okButton->setText(QApplication::translate("Dialog_ImageResample", "OK", 0));
        infolabel->setText(QApplication::translate("Dialog_ImageResample", "info: Image Resampling Options", 0));
    } // retranslateUi
