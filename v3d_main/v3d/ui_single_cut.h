...
public:
    ...
    {
        SingleCut->setWindowTitle(QApplication::translate("SingleCut", "Form", 0));
        orientButton->setText(QApplication::translate("SingleCut", "Orient", 0));
        axisBox->clear();
        axisBox->insertItems(0, QStringList()
         << QApplication::translate("SingleCut", "Free", 0)
         << QApplication::translate("SingleCut", "+X", 0)
         << QApplication::translate("SingleCut", "-X", 0)
         << QApplication::translate("SingleCut", "+Y", 0)
         << QApplication::translate("SingleCut", "-Y", 0)
         << QApplication::translate("SingleCut", "+Z", 0)
         << QApplication::translate("SingleCut", "-Z", 0)
        );
        nameField->setText(QApplication::translate("SingleCut", "Top", 0));
        edgeButton->setText(QApplication::translate("SingleCut", "Set Edge", 0));
        cutButton->setText(QApplication::translate("SingleCut", "Cut", 0));
        cutDistanceLineEdit->setText(QApplication::translate("SingleCut", "?", 0));
        label->setText(QApplication::translate("SingleCut", "&mu;m", 0));
    } // retranslateUi
