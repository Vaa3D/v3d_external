...
public:
    ...
    {
        Dialog_MaskROI->setWindowTitle(QApplication::translate("Dialog_MaskROI", "Dialog", 0));
        label->setText(QApplication::translate("Dialog_MaskROI", "Mask Region :", 0));
        maskregionBox->clear();
        maskregionBox->insertItems(0, QStringList()
         << QApplication::translate("Dialog_MaskROI", "XYZ cube by ROI intersection", 0)
         << QApplication::translate("Dialog_MaskROI", "XYZ cube by ROI union", 0)
         << QApplication::translate("Dialog_MaskROI", "XY Plane only", 0)
         << QApplication::translate("Dialog_MaskROI", "YZ Plane only", 0)
         << QApplication::translate("Dialog_MaskROI", "ZX Plane only", 0)
        );
        label_2->setText(QApplication::translate("Dialog_MaskROI", "Mask Channels :", 0));
        label_7->setText(QString());
        label_3->setText(QApplication::translate("Dialog_MaskROI", "first channel :", 0));
        label_4->setText(QApplication::translate("Dialog_MaskROI", "last channel :", 0));
        label_5->setText(QApplication::translate("Dialog_MaskROI", "filling value :", 0));
        label_6->setText(QApplication::translate("Dialog_MaskROI", "filling in or outside ROI :", 0));
        fillingroiBox->clear();
        fillingroiBox->insertItems(0, QStringList()
         << QApplication::translate("Dialog_MaskROI", "Outside ROI", 0)
         << QApplication::translate("Dialog_MaskROI", "Inside ROI", 0)
        );
        infolabel->setText(QApplication::translate("Dialog_MaskROI", "info: Mask ROI Options", 0));
        cancelButton->setText(QApplication::translate("Dialog_MaskROI", "Cancel", 0));
        okButton->setText(QApplication::translate("Dialog_MaskROI", "OK", 0));
    } // retranslateUi
