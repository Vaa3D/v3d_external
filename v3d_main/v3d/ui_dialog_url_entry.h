...
public:
    ...
    {
        V3dUrlDialog->setWindowTitle(QApplication::translate("V3dUrlDialog", "Load image stack from web URL", 0));
        label->setText(QApplication::translate("V3dUrlDialog", "Please type or paste URL of image stack below", 0));
        label_2->setText(QApplication::translate("V3dUrlDialog", "&URL:", 0));
        lineEdit->setText(QApplication::translate("V3dUrlDialog", "http://home.penglab.com/proj/vaa3d/data_v1.0/ex_Repo_hb9_eve.tif", 0));
        checkBox->setText(QApplication::translate("V3dUrlDialog", "Keep local copy of file", 0));
    } // retranslateUi
