...
public:
	...
	virtual void eraserSegProcess(V_NeuronSWC_list& displayingSegs, const float nodeCoords[]) = 0;
	virtual void connectSegProcess(V_NeuronSWC_list& displayingSegs, const float nodeCoords[]) = 0;
};
