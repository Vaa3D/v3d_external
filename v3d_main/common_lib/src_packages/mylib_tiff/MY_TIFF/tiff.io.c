...
static _Treader  Treader_Proto;

static int Treader_Offset = ((char *) &(Treader_Proto.treader)) - ((char *) &Treader_Proto);
...
static _Twriter  Twriter_Proto;

static int Twriter_Offset = ((char *) &(Twriter_Proto.twriter)) - ((char *) &Twriter_Proto);
...
{ _Twriter *object = (_Twriter *) (((char *) twriter) - Twriter_Offset);
  if (object->asize < asize)
    { twriter->annotation = Guarded_Realloc(twriter->annotation,asize,routine);
      object->asize = asize;
    }
}
...
{ _Twriter *object;
  ...
  allocate_twriter_annotation(twriter,asize,routine);
  return (twriter);
}
...
{ _Twriter *object  = (_Twriter *) (((char *) twriter) - Twriter_Offset);
  if (object->asize > twriter_asize(twriter))
    { object->asize = twriter_asize(twriter);
      if (object->asize != 0)
        twriter->annotation = Guarded_Realloc(twriter->annotation,
...
static _Tannotator  Tannotator_Proto;

static int Tannotator_Offset = ((char *) &(Tannotator_Proto.tannotator)) - ((char *) &Tannotator_Proto);
...
{ _Tannotator *object = (_Tannotator *) (((char *) tannotator) - Tannotator_Offset);
  if (object->asize < asize)
    { tannotator->annotation = Guarded_Realloc(tannotator->annotation,asize,routine);
      object->asize = asize;
    }
}
...
{ _Tannotator *object;
  ...
  allocate_tannotator_annotation(tannotator,asize,routine);
  return (tannotator);
}
...
{ _Tannotator *object  = (_Tannotator *) (((char *) tannotator) - Tannotator_Offset);
  if (object->asize > tannotator_asize(tannotator))
    { object->asize = tannotator_asize(tannotator);
      if (object->asize != 0)
        tannotator->annotation = Guarded_Realloc(tannotator->annotation,
...
static _TIFD  TIFD_Proto;

static int TIFD_Offset = ((char *) &(TIFD_Proto.tifd)) - ((char *) &TIFD_Proto);
...
{ _TIFD *object = (_TIFD *) (((char *) tifd) - TIFD_Offset);
  if (object->tsize < tsize)
    { tifd->tags = Guarded_Realloc(tifd->tags,tsize,routine);
      object->tsize = tsize;
    }
}
...
{ _TIFD *object = (_TIFD *) (((char *) tifd) - TIFD_Offset);
  if (object->vsize < vsize)
    { tifd->values = Guarded_Realloc(tifd->values,vsize,routine);
      object->vsize = vsize;
    }
}
...
{ _TIFD *object;
  ...
  allocate_tifd_tags(tifd,tsize,routine);
  allocate_tifd_values(tifd,vsize,routine);
...
{ _TIFD *object  = (_TIFD *) (((char *) tifd) - TIFD_Offset);
  if (object->tsize > tifd_tsize(tifd))
    { object->tsize = tifd_tsize(tifd);
      if (object->tsize != 0)
        tifd->tags = Guarded_Realloc(tifd->tags,
  ...
  if (object->vsize > tifd_vsize(tifd))
    { object->vsize = tifd_vsize(tifd);
      if (object->vsize != 0)
        tifd->values = Guarded_Realloc(tifd->values,
