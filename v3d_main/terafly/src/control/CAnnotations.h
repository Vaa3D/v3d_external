...
class terafly::CAnnotations
{
    ...
    public:
		...
		*****************************************************************/
        void write_annotations_helper(FILE* f, terafly::annotation* anoToAdd, std::map<long long, bool>& anosAdded, std::map<long long, long long>& old2new, long long &nextID);
