#LAST CHANGE BY HANCHUAN PENG. 2011-08-27. PORTING TO V3D PLUGIN FOLDER:x
...
DESTDIR       = ../../v3d/plugins/atlasguided_stranno/ #win32 qmake couldn't handle space in path
